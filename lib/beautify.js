...
module.exports = function js_beautify(js_source_text, options)
{
    ...
    line_starters = 'continue,try,throw,return,var,if,switch,case,for,while,break,function,default'.split(',');
        ...
        case 'TK_WORD':
            ...
            if (token_text === 'case' || token_text === 'default') {
                if (last_text === ':') {
                    ...
                    remove_indent();
                }else if(last_text === 'export'){
                    print_space();
                    // no need to forse new line on 'export'
                } else {
